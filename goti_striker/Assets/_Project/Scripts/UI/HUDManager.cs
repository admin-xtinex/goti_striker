...
#pragma warning disable CS0649
        ...
        {
            // Retired: Strike/Toss button replaced by Ground/Loft power-area swipe.
            Debug.LogWarning("[HUD] Strike button retired — use Ground/Loft power area.");
        }
        ...
        void HideLegacyStrikeIfShotControlPresent()
        {
            var shot = FindAnyObjectByType<ShotControlBinder>();
            if (shot != null && _strikeButton != null)
